...
public class MainActivity extends AppCompatActivity
    ...
    public void fetchdata(){
        ...
        DocumentReference docRef = db.collection("/faculty").document(current_uid);
        docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful())
                {
                    ...
                    ndept.setText(document.get("department").toString());
                    nname.setText(document.get("name").toString());
                    String image = document.get("timetable").toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ndept=findViewById(R.id.text_department);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_uploadattendance) {
            Intent attendance_intent= new Intent(MainActivity.this,DatePickerActivity.class);
